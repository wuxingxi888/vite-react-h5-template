...
- Prefer the client-side React guidance first.
- Apply Next.js-, RSC-, Server Actions-, and SSR-specific rules only when the target project actually uses those capabilities.
- If a rule conflicts with `.agents/rules/01-项目概述.md`, the project rules win.
